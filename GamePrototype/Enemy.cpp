...
Enemy::Enemy(Point2f pos, int health, EnemyType type, float radius, float speed) : m_Pos{ pos }, m_Health{ health }, m_DirectionVector{}, m_Speed{ rand() % 300 / 10.f + speed}, m_EnemyType{type}, m_DrawThingy{true}, m_Radius{radius}
{
}
